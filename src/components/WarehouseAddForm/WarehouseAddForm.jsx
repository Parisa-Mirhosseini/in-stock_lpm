            ...
            <div className="addwarehouse__form__form-wrap">
                <div className="addwarehouse__form__form-box">
                    <div className="addwarehouse__form__box--each">
                        ...
                        <label className="addwarehouse__form__label" htmlFor="warehouse_name">Warehouse Name</label>
                        <input
                        ...
                        />
                        {errors.warehouse_name && <p className="error">{errors.warehouse_name}</p>}

                        <label className="addwarehouse__form__label" htmlFor="address">Street Address</label>
                        <input
                        ...
                        <label className="addwarehouse__form__label" htmlFor="city">City</label>
                        <input
                            className="addwarehouse__form__input"
                            type="text"
                            id="city"
                        ...
                        <label className="addwarehouse__form__label" htmlFor="country">Country</label>
                        <input
                            className="addwarehouse__form__input"
                            type="text"
                            id="country"
                ...
                <div className="addwarehouse__form__box--each">
                    ...
                    <label className="addwarehouse__form__label" htmlFor="contact_name">Contact Name</label>
                    <input
                        className="addwarehouse__form__input"
                        type="text"
                        id="contact_name"
                    ...
                    <label className="addwarehouse__form__label" htmlFor="contact_position">Position</label>
                    <input
                        className="addwarehouse__form__input"
                        type="text"
                        id="contact_position"
                        ...
                        onChange={handleChange}
                    />
                    {errors.contact_position && <p className="error">{errors.contact_position}</p>}

                    <label className="addwarehouse__form__label" htmlFor="contact_phone">Phone Number</label>
                    <input
                        className="form__input"
                        type="text"
                        id="contact_phone"
                    ...
                    <label className="addwarehouse__form__label" htmlFor="contact_email">Email</label>
                    <input
                        className="form__input"
                        type="email"
                        id="contact_email"
                ...
                <section className="addwarehouse__form__btn-frame">
                    <button className="addwarehouse__form__btn-cancel" type="button" onClick={handleCancel}>
                        Cancel
                    </button>
